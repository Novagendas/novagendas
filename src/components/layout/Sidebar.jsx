...
const ICONS = {
  ...
  estadisticas:  <><rect x="3" y="12" width="5" height="9" /><rect x="9" y="7" width="5" height="14" /><rect x="15" y="3" width="5" height="18" /></>,
  ...
  feriados:      <><rect x="3" y="4" width="18" height="18" rx="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /><line x1="8" y1="14" x2="16" y2="14" /><line x1="8" y1="18" x2="12" y2="18" /></>,
  bot:           <><path d="M12 2a2 2 0 0 1 2 2v1h3a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h3V4a2 2 0 0 1 2-2z" /><circle cx="9" cy="11" r="1" /><circle cx="15" cy="11" r="1" /><path d="M9 15s1 1 3 1 3-1 3-1" /><line x1="8" y1="4" x2="8" y2="5" /><line x1="16" y1="4" x2="16" y2="5" /></>,
};
...
const ADMIN_NAV = [
  ...
  { id: 'bot',   label: 'Configuración Bot' },
];

const AGENDA_MGMT_NAV = [
  { id: 'feriados', label: 'Días Bloqueados' },
];
